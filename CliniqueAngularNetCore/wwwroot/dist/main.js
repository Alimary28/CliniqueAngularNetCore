...
/* harmony default export */ __webpack_exports__["default"] = ("<form [formGroup]=\"staffForm\" (ngSubmit)=\"save()\">\r\n    <div class=\"form-group\">\r\n        <label for=\"firstName\">Firstname</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"firstName\" name=\"firstName\" formControlName=\"firstName\">\r\n        <div *ngIf=\"staffForm.controls['firstName'].invalid && (staffForm.controls['firstName'].dirty || staffForm.controls['firstName'].touched)\"\r\n             class=\"text-danger\">\r\n            <div *ngIf=\"staffForm.controls['firstName'].errors.required\">\r\n                Firstname is required.\r\n            </div>\r\n            <div *ngIf=\"staffForm.controls['firstName'].errors.pattern\">\r\n                Firstname must contain only letters.\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <label>Lastname</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"lastName\" name=\"lastName\" formControlName=\"lastName\">\r\n        <div *ngIf=\"staffForm.controls['lastName'].invalid && (staffForm.controls['lastName'].dirty || staffForm.controls['lastName'].touched)\"\r\n             class=\"text-danger\">\r\n            <div *ngIf=\"staffForm.controls['lastName'].errors.required\">\r\n                Lastname is required.\r\n            </div>\r\n            <div *ngIf=\"staffForm.controls['lastName'].errors.pattern\">\r\n                Lastname must contain only letters.\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <label>Age</label>\r\n        <input type=\"number\" class=\"form-control\" id=\"age\" name=\"age\" formControlName=\"age\">\r\n        <div *ngIf=\"staffForm.controls['age'].invalid && (staffForm.controls['age'].dirty || staffForm.controls['age'].touched)\" class=\"text-danger\">\r\n            <div *ngIf=\"staffForm.controls['age'].errors.required\">\r\n                Age is required.\r\n            </div>\r\n            <div *ngIf=\"staffForm.controls['age'].errors.min\">\r\n                Age must be greater than 25.\r\n            </div>\r\n        </div>\r\n    </div>\r\n        <div class=\"form-group\">\r\n            <label>Position</label>\r\n            <select name=\"position\" formControlName=\"position\" class=\"form-control\">\r\n                <option value=\"Doctor\">Doctor</option>\r\n                <option value=\"Nurse\">Nurse</option>\r\n                <option value=\"Therapist\">Therapist</option>\r\n                <option value=\"Physician\">Physician</option>\r\n                <option value=\"Receptionist\">Receptionist</option>\r\n                <option value=\"Manager\">Manager</option>\r\n                <option value=\"Surgeon\">Surgeon</option>\r\n            </select>\r\n            <div *ngIf=\"staffForm.controls['position'].invalid && (staffForm.controls['position'].dirty || staffForm.controls['position'].touched)\" class=\"text-danger\">\r\n                <div *ngIf=\"staffForm.controls['position'].errors.required\">\r\n                    You must select a position.\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n        <div class=\"form-group\">\r\n            <label>Employment date</label>\r\n            <input type=\"text\" class=\"form-control\" id=\"employmentDate\" name=\"employmentDate\" formControlName=\"employmentDate\">\r\n            <div *ngIf=\"staffForm.controls['employmentDate'].invalid && (staffForm.controls['employmentDate'].dirty || staffForm.controls['employmentDate'].touched)\" class=\"text-danger\">\r\n                <div *ngIf=\"staffForm.controls['employmentDate'].errors.required\">\r\n                    Date is required\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n        <div class=\"form-group\">\r\n            <label>Salary</label>\r\n            <input type=\"number\" class=\"form-control\" id=\"salary\" name=\"salary\" formControlName=\"salary\">\r\n            <div *ngIf=\"staffForm.controls['salary'].invalid && (staffForm.controls['salary'].dirty || staffForm.controls['salary'].touched)\" class=\"text-danger\">\r\n                <div *ngIf=\"staffForm.controls['salary'].errors.required\">\r\n                    Salary is required.\r\n                </div>\r\n                <div *ngIf=\"staffForm.controls['salary'].errors.min\">\r\n                    Salary must be greater than 3500.\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!staffForm.valid\">Save</button>\r\n        <button class=\"btn btn-secondary\" type=\"button\" routerLink=\"/staff-list\">Cancel</button>\r\n    </form>\r\n");
...
let AddStaffComponent = class AddStaffComponent {
    ...
    createStaffForm() {
        this.staffForm = this.formBuilder.group({
            firstName: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(/^[a-zA-Z ]*$/)
                ])],
            lastName: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(/^[a-zA-Z ]*$/)
                ])],
            age: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].min(25)
                ])],
            position: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            employmentDate: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            salary: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].min(3500)
                ])]
        });
    }
    save() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".form-control {\r\n    position: relative;\r\n    box-sizing: border-box;\r\n    height: auto;\r\n    width: 100%;\r\n    padding: 10px;\r\n    font-size: 16px;\r\n}\r\n\r\nh1 {\r\n    text-align: center;\r\n}\r\n\r\n.form-control:focus {\r\n    z-index: 2;\r\n}\r\n\r\n.btn-primary {\r\n    margin-right: 10px;\r\n}\r\n\r\n.ng-invalid.ng-touched.form-control {\r\n    border: 1px solid red;\r\n}\r\n\r\n.header {\r\n    opacity: 0.8;\r\n    text-align: center;\r\n    padding: 0;\r\n    background-color: #eee;\r\n    width: 60%;\r\n    margin: auto;\r\n    margin-bottom: 10px;\r\n    margin-top: 20px;\r\n}\r\n\r\n#formRow {\r\n    box-shadow: 0px 4px 21px 0px rgba(0,0,0,0.75);\r\n    padding: 3rem;\r\n    width: 60%;\r\n    margin: auto;\r\n    background-color: #eee;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("input {\r\n    width: 100%;\r\n}\r\n\r\ntextarea {\r\n    width: 100%;\r\n    height: 100px;\r\n}\r\n\r\n.jumbotron {\r\n    text-align: center;\r\n    background-color: #c7bbbbc9;\r\n}\r\n\r\n.changeBackground {\r\n    margin-top: 2rem;\r\n    padding: 4rem;\r\n    background-color: #c7bbbbc9;\r\n    height: 100%;\r\n}\r\n\r\n@media screen and (min-width: 768px) {\r\n    #add-medical-service-style .jumbotron {\r\n        padding-top: 30px !important;\r\n        padding-bottom: 30px !important;\r\n        margin-right: -15px !important;\r\n    }\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card {\r\n    padding: 9px;\r\n}\r\n#details jumbotron {\r\n    margin-top: 10px;\r\n    padding-top: 8px;\r\n    padding-bottom: 28px;\r\n}\r\n#medicalServiceDetails {\r\n    background-color: #f8f8f8;\r\n}\r\n#medicalServiceDetails {\r\n    box-shadow: 0px 4px 21px 0px rgba(0,0,0,0.75);\r\n    padding: 3rem;\r\n}\r\n#details h1 {\r\n    text-align: center;\r\n    color: black;\r\n}\r\n.card {\r\n    font-size: 15px;\r\n    background-color: #f8f8f8;\r\n}\r\nbutton {\r\n   \r\n    margin: 5px;\r\n}\r\n.container h4 {\r\n    margin-bottom: 20px;\r\n    margin-top: 20px;\r\n}\r\n#crud-medicalService-btn {\r\n    padding-right: 0 !important;\r\n    padding-left: 0 !important;\r\n}\r\n.btn-primary {\r\n    margin-right: 10px;\r\n}\r\n#medicalServiceDetails-btn {\r\n    margin-bottom: 20px;\r\n}\r\n@media screen and (min-width: 768px) {\r\n    #details .jumbotron {\r\n        padding-top: 30px !important;\r\n        padding-bottom: 30px !important;\r\n        margin-right: -15px !important;\r\n    }\r\n}\r\n.h4 {\r\n    font-size: 20px;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card {\r\n    padding: 9px;\r\n}\r\n\r\n/*.container {\r\n    background-image: url(https://doctorokz.com/wp-content/uploads/2018/02/bg1.png);\r\n    background-repeat: no-repeat;\r\n    background-size: cover;\r\n    background-position: center;\r\n    position: fixed;\r\n    width: 100%;\r\n    height: 100%;\r\n    margin: 0;\r\n}*/\r\n\r\n.h4 {\r\n    font-size: 20px;\r\n}\r\n\r\n.wmx12 {\r\n    max-width: 97.2307692rem !important;\r\n}\r\n\r\n.grid {\r\n    display: flex;\r\n}\r\n\r\n.mx-auto {\r\n    margin-right: auto !important;\r\n    margin-left: auto !important;\r\n}\r\n\r\n.searchbar {\r\n    color: var(--black-800);\r\n    flex-shrink: 10000;\r\n}\r\n\r\n.fl-grow1 {\r\n    flex-grow: 1;\r\n}\r\n\r\n.px12 {\r\n    padding-left: 12px !important;\r\n    padding-right: 12px !important;\r\n}\r\n\r\n.searchbar .s-input {\r\n    border-color: #9199a1;\r\n    background-color: #fff;\r\n    box-shadow: none;\r\n    color: #383f47;\r\n}\r\n\r\n.s-input.s-input__search {\r\n    padding-left: 32px;\r\n    width: 100%;\r\n}\r\n\r\n.s-input {\r\n    -webkit-appearance: none;\r\n    width: 80%;\r\n    margin: 0;\r\n    padding: .6em .7em;\r\n    border: 1px solid #9fa2a5;\r\n    border-radius: 3px;\r\n    font-size: 13px;\r\n    font-family: inherit;\r\n    line-height: 1.15384615;\r\n}\r\n\r\n.ps-relative {\r\n    position: relative !important;\r\n    display: block;\r\n    padding: 0;\r\n    border: 0;\r\n    font: inherit;\r\n    font-size: 100%;\r\n    vertical-align: baseline;\r\n}\r\n\r\n.jumbotron {\r\n    margin-top: 10px;\r\n    padding-top: 8px;\r\n    padding-bottom: 28px;\r\n}\r\n\r\n.s-input-icon.s-input-icon__search {\r\n    right: auto;\r\n    left: .7em;\r\n    color: var(--black-200);\r\n}\r\n\r\n.svg-icon {\r\n    vertical-align: bottom;\r\n}\r\n\r\n.s-input-icon {\r\n    position: absolute;\r\n    top: 50%;\r\n    margin-top: -9px;\r\n    pointer-events: none;\r\n}\r\n\r\n.svg-icon:not(.native) * {\r\n    fill: currentColor;\r\n}\r\n\r\n.jumbotron h1, p {\r\n    text-align: center;\r\n}\r\n\r\n.card:hover { /* IE 9 */ /* Safari 3-8 */\r\n   transform: scale(1.05);\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("input {\r\n    width: 100%;\r\n}\r\n\r\ntextarea {\r\n    width: 100%;\r\n    height: 100px;\r\n}\r\n\r\n.btn-primary {\r\n    margin-right: 10px;\r\n}\r\n\r\nlabel {\r\n    color: white;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let UpdateMedicalServiceComponent = class UpdateMedicalServiceComponent {
    ...
    initForm() {
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            domain: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.selectedMedicalService.domain, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.selectedMedicalService.name, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            description: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.selectedMedicalService.description, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            minutes: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.selectedMedicalService.minutes, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(10)]),
            price: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.selectedMedicalService.price, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(10)])
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/*#login {\r\n    background-image: url(https://doctorokz.com/wp-content/uploads/2018/02/bg1.png);\r\n    background-size: cover;\r\n    background-repeat: no-repeat;\r\n    height: 100%;\r\n}*/\r\n\r\n.container {\r\n    height: 100%;\r\n    align-content: center;\r\n}\r\n\r\n.card {\r\n    height: 370px;\r\n    margin-top: auto;\r\n    margin-bottom: auto;\r\n    width: 400px;\r\n    background-color: rgba(0,0,0,0.7) !important;\r\n}\r\n\r\n.card-header h3 {\r\n    color: white;\r\n}\r\n\r\n.input-group-prepend span {\r\n    width: 50px;\r\n    background-color: #FFC312;\r\n    color: black;\r\n    border: 0 !important;\r\n}\r\n\r\ninput:focus {\r\n    outline: 0 0 0 0 !important;\r\n    box-shadow: 0 0 0 0 !important;\r\n}\r\n\r\n.remember input {\r\n    width: 20px;\r\n    height: 20px;\r\n    margin-left: 15px;\r\n    margin-right: 5px;\r\n}\r\n\r\n.login_btn {\r\n    color: #fff;\r\n    background-color: #1e7e34;\r\n    border-color: #1c7430;\r\n    width: 20%;\r\n}\r\n\r\n.login_btn:hover {\r\n    color: #fff;\r\n    background-color: #449d44;\r\n    border-color: #398439;\r\n}\r\n\r\n.links {\r\n    color: white;\r\n}\r\n\r\n.links a {\r\n    margin-left: 10px;\r\n}\r\n\r\n.subLinks {\r\n    color: black;\r\n    font-size: 14px;\r\n    font-weight: 600;\r\n}\r\n\r\n.ng-invalid.ng-touched.form-control {\r\n    border: 1px solid red;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("a.navbar-brand {\r\n    font-size: inherit;\r\n    white-space: normal;\r\n    text-align: center;\r\n    word-break: break-all;\r\n}\r\n\r\nhtml {\r\n    font-size: 16px;\r\n}\r\n\r\n@media (min-width: 768px) {\r\n    html {\r\n        font-size: 16px;\r\n    }\r\n}\r\n\r\n.box-shadow {\r\n    box-shadow: 0 .25rem .75rem rgba(0, 0, 0, .05);\r\n}\r\n\r\n@media (min-width: 768px) {\r\n    .navbar-collapse.collapse {\r\n        display: flex !important\r\n    }\r\n}\r\n\r\n.dropdown-toggle, .dropdown-item {\r\n    cursor: pointer;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/*#login {\r\n    background-image: url(https://doctorokz.com/wp-content/uploads/2018/02/bg1.png);\r\n    background-size: cover;\r\n    background-repeat: no-repeat;\r\n    width: 100%;\r\n    height: 100%;\r\n}*/\r\n\r\n.container {\r\n    height: 100%;\r\n    align-content: center;\r\n}\r\n\r\n.card {\r\n    height: 580px;\r\n    margin-top: auto;\r\n    margin-bottom: auto;\r\n    width: 400px;\r\n    background-color: rgba(0,0,0,0.7) !important;\r\n}\r\n\r\n.card-header h3 {\r\n    color: white;\r\n}\r\n\r\n.input-group-prepend span {\r\n    width: 50px;\r\n    background-color: #FFC312;\r\n    color: black;\r\n    border: 0 !important;\r\n}\r\n\r\ninput:focus {\r\n    outline: 0 0 0 0 !important;\r\n    box-shadow: 0 0 0 0 !important;\r\n}\r\n\r\n.remember input {\r\n    width: 20px;\r\n    height: 20px;\r\n    margin-left: 15px;\r\n    margin-right: 5px;\r\n}\r\n\r\n.login_btn {\r\n    color: #fff;\r\n    background-color: #1e7e34;\r\n    border-color: #1c7430;\r\n    width: 20%;\r\n}\r\n\r\n.login_btn:hover {\r\n        color: #fff;\r\n        background-color: #449d44;\r\n        border-color: #398439;\r\n    }\r\n\r\n.links {\r\n    color: white;\r\n}\r\n\r\n.links a {\r\n        margin-left: 10px;\r\n    }\r\n\r\n.subLinks {\r\n    color: black;\r\n    font-size: 14px;\r\n    font-weight: 600;\r\n}\r\n\r\n.ng-invalid.ng-touched.form-control {\r\n    border: 1px solid red;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card {\r\n    padding: 9px;\r\n}\r\n\r\n#details jumbotron {\r\n    margin-top: 10px;\r\n    padding-top: 8px;\r\n    padding-bottom: 28px;\r\n}\r\n\r\n#staffDetails {\r\n    background-color: #f8f8f8;\r\n}\r\n\r\n#staffDetails {\r\n    box-shadow: 0px 4px 21px 0px rgba(0,0,0,0.75);\r\n    padding: 3rem;\r\n}\r\n\r\n#details.container {\r\n    /*background-image: url(https://doctorokz.com/wp-content/uploads/2018/02/bg1.png);\r\n    background-repeat: no-repeat;\r\n    background-size: cover;\r\n    background-position: center;\r\n    position: fixed;\r\n    width: 100%;\r\n    height: 100%;*/\r\n    overflow: scroll;\r\n}\r\n\r\n#details h1 {\r\n    text-align: center;\r\n    color: black;\r\n}\r\n\r\n.card {\r\n    font-size: 15px;\r\n    background-color: #f8f8f8;\r\n}\r\n\r\nbutton {\r\n    margin: 5px;\r\n}\r\n\r\n.container h4 {\r\n    margin-bottom: 20px;\r\n    margin-top: 20px;\r\n}\r\n\r\n#crud-staff-btn {\r\n    padding-right: 0 !important;\r\n    padding-left: 0 !important;\r\n}\r\n\r\n.btn-primary {\r\n    margin-right: 10px;\r\n}\r\n\r\n#staffDetails-btn {\r\n    margin-bottom: 20px;\r\n}\r\n\r\n@media screen and (min-width: 768px) {\r\n    #details .jumbotron {\r\n        padding-top: 30px !important;\r\n        padding-bottom: 30px !important;\r\n        margin-right: -15px !important;\r\n    }\r\n}\r\n\r\n.h4 {\r\n    font-size: 20px;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card {\r\n    padding: 9px;\r\n}\r\n\r\n/*.container {\r\n    background-image: url(https://doctorokz.com/wp-content/uploads/2018/02/bg1.png);\r\n    background-repeat: no-repeat;\r\n    background-size: cover;\r\n    background-position: center;\r\n    position: fixed;\r\n    width: 100%;\r\n    height: 100%;\r\n    margin: 0;\r\n}*/\r\n\r\n.h4 {\r\n    font-size: 20px;\r\n}\r\n\r\n.wmx12 {\r\n    max-width: 97.2307692rem !important;\r\n}\r\n\r\n.grid {\r\n    display: flex;\r\n}\r\n\r\n.mx-auto {\r\n    margin-right: auto !important;\r\n    margin-left: auto !important;\r\n}\r\n\r\n.searchbar {\r\n    color: var(--black-800);\r\n    flex-shrink: 10000;\r\n}\r\n\r\n.fl-grow1 {\r\n    flex-grow: 1;\r\n}\r\n\r\n.px12 {\r\n    padding-left: 12px !important;\r\n    padding-right: 12px !important;\r\n}\r\n\r\n.searchbar .s-input {\r\n    border-color: #9199a1;\r\n    background-color: #fff;\r\n    box-shadow: none;\r\n    color: #383f47;\r\n}\r\n\r\n.s-input.s-input__search {\r\n    padding-left: 32px;\r\n    width: 100%;\r\n}\r\n\r\n.s-input {\r\n    -webkit-appearance: none;\r\n    width: 80%;\r\n    margin: 0;\r\n    padding: .6em .7em;\r\n    border: 1px solid #9fa2a5;\r\n    border-radius: 3px;\r\n    font-size: 13px;\r\n    font-family: inherit;\r\n    line-height: 1.15384615;\r\n}\r\n\r\n.ps-relative {\r\n    position: relative !important;\r\n    display: block;\r\n    padding: 0;\r\n    border: 0;\r\n    font: inherit;\r\n    font-size: 100%;\r\n    vertical-align: baseline;\r\n}\r\n\r\n.jumbotron {\r\n    margin-top: 10px;\r\n    padding-top: 8px;\r\n    padding-bottom: 28px;\r\n}\r\n\r\n.s-input-icon.s-input-icon__search {\r\n    right: auto;\r\n    left: .7em;\r\n    color: var(--black-200);\r\n}\r\n\r\n.svg-icon {\r\n    vertical-align: bottom;\r\n}\r\n\r\n.s-input-icon {\r\n    position: absolute;\r\n    top: 50%;\r\n    margin-top: -9px;\r\n    pointer-events: none;\r\n}\r\n\r\n.svg-icon:not(.native) * {\r\n    fill: currentColor;\r\n}\r\n\r\n.jumbotron h1, p {\r\n    text-align: center;\r\n}\r\n\r\n.card:hover { /* IE 9 */ /* Safari 3-8 */\r\n    transform: scale(1.05);\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("input {\r\n    width: 100%;\r\n}\r\n\r\ntextarea {\r\n    width: 100%;\r\n    height: 100px;\r\n}\r\n\r\n.btn-primary {\r\n    margin-right: 10px;\r\n}\r\n\r\n/*#add-medical-service-style .container {\r\n    background-image: url(https://doctorokz.com/wp-content/uploads/2018/02/bg1.png);\r\n    background-repeat: no-repeat;\r\n    background-size: cover;\r\n    background-position: center;\r\n    position: fixed;\r\n    width: 100%;\r\n    height: 100%;\r\n    margin: 0;\r\n}*/\r\n\r\nlabel {\r\n    color: black;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
